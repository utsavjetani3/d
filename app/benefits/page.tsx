  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <FadeIn className="text-center mb-24">
        ...
        <p className="text-gray-500 text-xl md:text-2xl max-w-3xl mx-auto font-medium leading-relaxed italic">
          Discover why the ancient wisdom of Neem Datun is still the most effective oral care solution today.
        </p>
      </FadeIn>

      <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-32">
        {[
          ...
          <StaggerItem key={i}>
            <div className="bg-white p-10 rounded-[3rem] border border-brand-green/5 soft-shadow hover:scale-[1.02] transition-all duration-500 group h-full">
        ...
        <div className="bg-brand-green rounded-[4rem] p-12 md:p-24 overflow-hidden relative">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-white">
              <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight">Datun vs. <br />Plastic Brushes</h2>
              <p className="text-white/80 text-lg mb-10 font-medium">Why millions are switching back to the roots of oral care.</p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-[3rem] border border-white/20 p-12">
      ...
      <FadeIn className="text-center">
        <h2 className="text-4xl font-black text-foreground mb-8">Ready to start your natural journey?</h2>
        <Link href="/datasets">
          <Button variant="primary" size="lg" className="px-12 py-6 text-xl">
            Explore Products
          </Button>
        </Link>
      </FadeIn>
