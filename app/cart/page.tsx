    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <FadeIn>
        <div className="flex items-center gap-4 mb-16">
          ...
          <h1 className="text-5xl font-black text-foreground tracking-tight">Shopping Bag</h1>
        </div>
      </FadeIn>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <StaggerContainer className="space-y-8">
            {items.map((item) => (
              <StaggerItem key={item.id}>
                <div className="bg-white p-8 flex flex-col sm:flex-row items-center gap-8 group rounded-[2.5rem] soft-shadow border border-brand-green/5">
                  ...
                  <div className="flex-grow text-center sm:text-left">
                    <h3 className="text-2xl font-black text-foreground mb-2 group-hover:text-brand-green transition-colors">
                      {item.title}
                    </h3>
        ...
        <div className="lg:col-span-1">
          <FadeIn delay={0.2} className="sticky top-32">
            <div className="bg-white p-10 rounded-[3rem] soft-shadow border-2 border-brand-green/10">
              <h2 className="text-2xl font-black text-foreground mb-10 tracking-tight">Order Summary</h2>
              <div className="space-y-6 mb-10">
                ...
                <div className="pt-6 border-t border-brand-green/5 flex justify-between">
                  ...
                  <span className="text-3xl font-black text-brand-green">${total.toFixed(2)}</span>
                </div>
              </div>
              <Button variant="primary" size="lg" className="w-full py-6 text-xl">
                Checkout Now
              </Button>
