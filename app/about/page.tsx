...
export default function AboutPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
      <FadeIn className="max-w-4xl mx-auto text-center mb-16 md:mb-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center mb-20 md:mb-40">
        <FadeIn direction="right">
          <div className="aspect-[4/5] bg-brand-beige rounded-[2.5rem] md:rounded-[4rem] overflow-hidden relative soft-shadow">
            <div className="absolute inset-0 flex items-center justify-center">
              <Leaf className="w-40 h-40 md:w-64 md:h-64 text-brand-green/10" />
            </div>
            <div className="absolute bottom-6 left-6 right-6 md:bottom-12 md:left-12 md:right-12 bg-white/80 backdrop-blur-md p-6 md:p-10 rounded-[2rem] md:rounded-[3rem] border border-brand-green/5">
              <p className="text-2xl md:text-3xl font-black text-brand-green mb-2 tracking-tight">Authentic Heritage</p>
        ...
        <FadeIn direction="left" className="space-y-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-black text-foreground mb-6 tracking-tight">The Story of Datun</h2>
            <p className="text-gray-500 text-base md:text-lg font-medium leading-relaxed mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-8">
            ...
            <div className="space-y-2">
              <p className="text-3xl md:text-4xl font-black text-brand-green">0%</p>
      ...
      <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-20 md:mb-40">
        {[
      ...
      <FadeIn className="bg-brand-beige rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 text-center border border-brand-green/5">
        <Heart className="w-16 h-16 text-brand-green/30 mx-auto mb-10" />
        <h2 className="text-3xl md:text-4xl font-black text-foreground mb-8 tracking-tight">Our Commitment to You</h2>
        <p className="text-gray-500 text-base md:text-xl font-medium max-w-2xl mx-auto mb-12">
